                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="subname" class="col-md-4 col-form-label text-md-right">{{ __('subname') }}</label>

                            <div class="col-md-6">
                                <input id="subname" type="text" class="form-control{{ $errors->has('subname') ? ' is-invalid' : '' }}" name="subname" value="{{ old('subname') }}" required autofocus>
